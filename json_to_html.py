...
def generate_resume_html(json_file):
    ...
    website_svg = f'''<svg fill="#000000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="{icon_size}" height="{icon_size}"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"></path> </g></svg>'''
...
<body>
    <div class="container">
        ...
        <div class="section">
          <div style="display: flex; gap: 270px; align-items: center; width: 100%;">
            ...
            <div class="contact-info">
              ...
              <!-- Website -->
              <a class="contact-item" href="{contact_website_link}" target="_blank" rel="noopener noreferrer" style="display: flex; align-items: center; gap: 8px;">
                <img src="https://cdn-icons-png.flaticon.com/512/1006/1006771.png" alt="Website" width="{icon_size}" height="{icon_size}" />
                khushalsindhav.com
              </a>
            </div>
          </div>
        ...
        contact_website_link=resume_data['header']['contact']['website'],
